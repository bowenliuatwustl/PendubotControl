...
typedef RT_MODEL_Sep6_Task2 RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Sep6_Task2(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Sep6_Task2_initialize();
   extern void Sep6_Task2_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Sep6_Task2_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://Sep6_Task2:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Sep6_Task2 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
